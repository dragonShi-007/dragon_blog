...
import (
	...
	"github/dragonShi-007/go-blog/models"
	"github/dragonShi-007/go-blog/system"
)
...
func CommentPost(c *gin.Context) {
	...
	NotifyEmail("[go-blog]您有一条新评论", fmt.Sprintf("<a href=\"%s/post/%d\" target=\"_blank\">%s</a>:%s", system.GetConfiguration().Domain, post.ID, post.Title, content))
	res["succeed"] = true
}
